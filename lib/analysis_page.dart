                ...
                children: [
                  ...
                  Card(
                    ...
                    child: Padding(
                      ...
                      child: _buildPieChartSection(title: '支出分析', isExpense: true, txns: expenseTxns),
                    ),
                  ),
                  ...
                  Card(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.all(16),
                      child: _buildPieChartSection(title: '收入分析', isExpense: false, txns: incomeTxns, incomeColors: true),
                    ),
                  ),
                  const SizedBox(height: 16),
                  ...
                  _buildNavigationCard(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (_) => const SavingsProgressPage()),
                      );
                    },
                  ),
